...
<h1>🔮 THE HAWTHORNE DIRECTIVES 🔮</h1>
...
| ⚡ FRACTURE | English | 📜 PALIMPSEST | Arabic (Egyptian) |
| 🥀 WILT | Polish | 🔥 SCORIA | Italian |
| 👁️ RESIDUE | Portuguese (BR) | 🕰️ TRIPWIRE | German |
...
- **Report Card entries** (grade evaluation framework)
- **XML/structural wrappers** (tags, conditionals, macro syntax)
- **Boot sequence and main prompt core**
...
Per-Director creative and operational content:

- Genre descriptions and department briefs
...
5. Configure toggles to taste

For full documentation — Directors, systems, toggles, troubleshooting — see the primary HawThorne README.
